    ...
    Do Until burials.EOF
        ...
        If Not MNIQueryBuilder.EOF And Not MNIQueryBuilder.BOF Then
                ...
                If Not CalcIndividuals.EOF And Not CalcIndividuals.BOF Then
                    ...
                    Do Until CalcIndividuals.EOF
                        If AgeCategory = "juvenile" Then
                            If CurrentJuvenileCount < CalcIndividuals![CountOfIn_Feature] Then CurrentJuvenileCount = CalcIndividuals![CountOfIn_Feature]
                        ElseIf AgeCategory = "neonate" Then
                            If CurrentNeonateCount < CalcIndividuals![CountOfIn_Feature] Then CurrentNeonateCount = CalcIndividuals![CountOfIn_Feature]
                        Else 'adult
                            If CurrentAdultCount < CalcIndividuals![CountOfIn_Feature] Then CurrentAdultCount = CalcIndividuals![CountOfIn_Feature]
                        End If
            ...
            If AbleToCalc = True Then
                sqlInsert = "INSERT INTO [HR_Feature_MNI] ([FeatureNumber], [MNI], [Adults], [Juveniles], [Neonates], [LastGenerated]) VALUES (" & CurrentFeatureNo & ", " & CurrentAdultCount + CurrentJuvenileCount + CurrentNeonateCount & "," & CurrentAdultCount & "," & CurrentJuvenileCount & ", " & CurrentNeonateCount & ", '" & Now() & "');"
            Else
        ...
        If Not MNIQueryBuilder.EOF And Not MNIQueryBuilder.BOF Then
            ...
            Do Until MNIQueryBuilder.EOF
                ...
                If Not CalcIndividuals.EOF And Not CalcIndividuals.BOF Then
                    ...
                    Do Until CalcIndividuals.EOF
                        If AgeCategory = "juvenile" Then
                            If CurrentJuvenileCount < CalcIndividuals![CountOfIn_Space] Then CurrentJuvenileCount = CalcIndividuals![CountOfIn_Space]
                        ElseIf AgeCategory = "neonate" Then
                            If CurrentNeonateCount < CalcIndividuals![CountOfIn_Space] Then CurrentNeonateCount = CalcIndividuals![CountOfIn_Space]
                        Else 'adult
                            If CurrentAdultCount < CalcIndividuals![CountOfIn_Space] Then CurrentAdultCount = CalcIndividuals![CountOfIn_Space]
                        End If
                    CalcIndividuals.MoveNext
                    Loop
                Else
            ...
            Loop
            If AbleToCalc = True Then
                sqlInsert = "INSERT INTO [HR_Space_MNI] ([SpaceNumber], [MNI], [Adults], [Juveniles], [Neonates], [LastGenerated]) VALUES (" & CurrentSpaceNo & ", " & CurrentAdultCount + CurrentJuvenileCount + CurrentNeonateCount & "," & CurrentAdultCount & "," & CurrentJuvenileCount & ", " & CurrentNeonateCount & ", '" & Now() & "');"
            Else
